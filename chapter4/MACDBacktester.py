...
class MACDBacktester(): 
    ...
    ==========
    data: data frame
        data frame witht he data and date index
    EMA_S: int
    ...
    def __init__(self, raw, EMA_S, EMA_L, signal_mw, tc):
        self.raw = raw
        self.EMA_S = EMA_S
        self.EMA_L = EMA_L
    ...
    def __repr__(self):
        return "MACDBacktester(MACD({}, {}, {}))".format(self.EMA_S, self.EMA_L, self.signal_mw)
    ...
    def plot_results(self):
        ...
        if self.results is None:
            ...
            title = "{} | MACD ({}, {}, {}) | TC = {}".format(self.EMA_S, self.EMA_L, self.signal_mw, self.tc)
